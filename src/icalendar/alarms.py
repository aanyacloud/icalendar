...
class AlarmTime:
    ...
    Attributes:
        ...
        trigger (datetime): The datetime at which the alarm is triggered.
        acknowledged_until (datetime | None): Time in UTC until which the alarm
            has been acknowledged, if any.
        snoozed_until (datetime | None): Time in UTC until which the alarm is
            snoozed, if any.
